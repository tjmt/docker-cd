...
# docker-compose -f "docker-compose.cd-deploy-release.yml" up --abort-on-container-exit
# docker-compose -f "docker-compose.cd-deploy-release.yml" down --rmi all -v --remove-orphans
echo "-----------------------------------------------------------------------"
